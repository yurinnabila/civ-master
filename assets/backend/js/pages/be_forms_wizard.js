    ...
    var initWizardValidation = function(){
        ...
        var validatorClassic = formClassic.validate({
            ...
            messages: {
                ...
                'nomor': 'Input nomor tidak boleh kosong!',
                'nomor_bangunan': 'Input nomor bangunan tidak boleh kosong!',
                'imb': 'Input IMB tidak boleh kosong!',
                'ketinggian': 'Input ketinggian tidak boleh kosong!',
                'luas_bangunan': 'Input luas bangunan tidak boleh kosong!',
                'lapis': 'Input Lapis tidak boleh kosong!',
                'alamat': 'Input Alamat tidak boleh kosong!',
                'provinsi': 'Input provinsi tidak boleh kosong!',
                'kabupaten': 'Input kabupaten tidak boleh kosong!',
                'kecamatan': 'Input kecamatan tidak boleh kosong!',
                'kelurahan': 'Input kelurahan tidak boleh kosong!',
                'rt': 'Input rt tidak boleh kosong!',
                'rw': 'Input rw tidak boleh kosong!',
                'luas_tanah': 'Input luas tanah tidak boleh kosong!',
                'staus_tanah': 'Input stautus tanah tidak boleh kosong!',
                'fungsi': 'Input fungsi tidak boleh kosong!',
            }
        });
