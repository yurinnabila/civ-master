<?php $base_url = "https://app.demoo.id/surakarta/database_perumahan/"; ?>
...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Database Perumahan | Surakarta</title>

        <meta name="description" content="Database Perumahan | Surakarta">
        <meta name="author" content="pixelcave">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="Database Perumahan | Surakarta">
        <meta property="og:site_name" content="Database Perumahan Kota Surakarta Dinas Perumahan dan Permukiman">
        <meta property="og:description" content="Database Perumahan Kota Surakarta Dinas Perumahan dan Permukiman">
                    ...
                    <div class="hero-inner">
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                ...
                                <h1 class="h2 font-w700 mt-30 mb-10">Halaman yang ada cari tidak ditemukan</h1>
                            </div>
                        </div>
                    </div>
                </div>
