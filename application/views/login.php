    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('<?= base_url('uploads/') ?>solo.png');">
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="index.html">
                                        ...
                                        <span class="font-size-xl text-primary-dark">civilarch</span><span class="font-size-xl">.ID</span>
                                    </a>
                                    <h1 class="h3 font-w700 mt-30 mb-10">Silakan Log In dengan akun Anda</h1>
                                ...
                                <form action="<?= base_url('login/processing')?>" class="js-validation-signin px-30" method="post" id="forms">
